...
void Scene5Controller::BeginContact(b2Contact* contact) {
 ...
 */
void Scene5Controller::CreateBall(ofVec2f position, ofVec2f velocity,
...
void Scene5Controller::CreateBorder() {
...
void Scene5Controller::CreateCourt() {
...
void Scene5Controller::CreateNet() {
...
void Scene5Controller::DestroyBall(b2Body *ball) {
  ball->DestroyFixture(ball->GetFixtureList());
  model_.world.DestroyBody(ball);
}

bool Scene5Controller::MouseButtonIsPressed(int button) {
  return buttons[button];
}

void Scene5Controller::RacketCollide(ofVec2f racket_position, ofVec2f hit_direction,
